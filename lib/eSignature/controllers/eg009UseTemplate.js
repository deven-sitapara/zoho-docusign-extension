...
const templateId = "2bbe88a1-6b93-47dd-aa96-c7164f137242";
//const envelopeId = "c279f13b-0a5b-4246-b4d5-6ff590e3da27";
...
eg009UseTemplate.createController = async (req, res) => {
  ...
  if (!req.session.templateId) {
    res.render("pages/examples/eg009UseTemplate", {
      ...
      sourceUrl:
        dsConfig.githubExampleUrl + "eSignature/" + path.basename(__filename),
...
eg009UseTemplate.getController = (req, res) => {
  ...
  if (tokenOK) {
    ...
    res.render("pages/examples/eg009UseTemplate", {
      ...
      sourceUrl:
        dsConfig.githubExampleUrl + "eSignature/examples/" + sourceFile,
      documentation: dsConfig.documentation + eg,
      showDoc: dsConfig.documentation,
    });
  } else {
